...
import { addCommonChain, getBuildConfig, getCwd, getDefineEnv, loadConfig, loadModuleFromFramework, logErr, setStyle } from 'ssr-common-utils'
...
function getBaseConfig(chain: WebpackChain, isServer: boolean) {
